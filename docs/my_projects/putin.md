...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="/pics/1.jpg" class="d-block w-100" alt="Картинка 1">
    </div>
    <div class="carousel-item">
      <img src="/pics/2.jpg" class="d-block w-100" alt="Картинка 2">
    </div>
    <div class="carousel-item">
      <img src="/pics/3.jpg" class="d-block w-100" alt="Картинка 3">
    </div>
  </div>
